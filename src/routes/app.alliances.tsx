...
function AllianceCard({ alliance, members }: { alliance: string; members: Merchant[] }) {
  return (
    <div className="overflow-hidden rounded-2xl border border-border bg-card/50 shadow-panel ring-1 ring-foreground/[0.02] ring-inset backdrop-blur-sm transition-colors duration-300 hover:border-line-strong">
